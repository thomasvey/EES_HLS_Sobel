...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=932,HLS_SYN_LUT=2323}" *)
...
reg    ap_rst_n_inv;
wire    Block_Mat_exit57_pro_U0_ap_start;
wire    Block_Mat_exit57_pro_U0_start_full_n;
wire    Block_Mat_exit57_pro_U0_ap_done;
wire    Block_Mat_exit57_pro_U0_ap_continue;
wire    Block_Mat_exit57_pro_U0_ap_idle;
wire    Block_Mat_exit57_pro_U0_ap_ready;
wire    Block_Mat_exit57_pro_U0_start_out;
wire    Block_Mat_exit57_pro_U0_start_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_0_rows_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_0_rows_V_out_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_0_cols_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_0_cols_V_out_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_1_rows_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_1_rows_V_out_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_1_cols_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_1_cols_V_out_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_2_rows_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_2_rows_V_out_write;
wire   [31:0] Block_Mat_exit57_pro_U0_img_2_cols_V_out_din;
wire    Block_Mat_exit57_pro_U0_img_2_cols_V_out_write;
...
reg    ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready;
wire    ap_sync_Block_Mat_exit57_pro_U0_ap_ready;
reg   [1:0] Block_Mat_exit57_pro_U0_ap_ready_count;
...
#0 ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready = 1'b0;
#0 Block_Mat_exit57_pro_U0_ap_ready_count = 2'd0;
end

Block_Mat_exit57_pro Block_Mat_exit57_pro_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (1'b0 == Block_Mat_exit57_pro_U0_ap_ready))) begin
        Block_Mat_exit57_pro_U0_ap_ready_count <= (Block_Mat_exit57_pro_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (1'b1 == Block_Mat_exit57_pro_U0_ap_ready))) begin
        Block_Mat_exit57_pro_U0_ap_ready_count <= (Block_Mat_exit57_pro_U0_ap_ready_count + 2'd1);
    end
end
...
assign Block_Mat_exit57_pro_U0_ap_continue = 1'b1;

assign Block_Mat_exit57_pro_U0_ap_start = ((ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready ^ 1'b1) & ap_start);

assign Block_Mat_exit57_pro_U0_start_full_n = (start_for_Mat2AXIvideo_U0_full_n & start_for_CvtColor_U0_full_n);
...
assign ap_idle = (Mat2AXIvideo_U0_ap_idle & CvtColor_U0_ap_idle & CvtColor_1_U0_ap_idle & Block_Mat_exit57_pro_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign ap_sync_Block_Mat_exit57_pro_U0_ap_ready = (ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready | Block_Mat_exit57_pro_U0_ap_ready);

assign ap_sync_continue = 1'b1;

assign ap_sync_done = Mat2AXIvideo_U0_ap_done;

assign ap_sync_ready = (ap_sync_Block_Mat_exit57_pro_U0_ap_ready & ap_sync_AXIvideo2Mat_U0_ap_ready);
