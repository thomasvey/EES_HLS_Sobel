...
image_filter::image_filter(sc_module_name name) : sc_module(name), mVcdFile(0) {
    Block_Mat_exit57_pro_U0 = new Block_Mat_exit57_pro("Block_Mat_exit57_pro_U0");
    Block_Mat_exit57_pro_U0->ap_clk(ap_clk);
    Block_Mat_exit57_pro_U0->ap_rst(ap_rst_n_inv);
    Block_Mat_exit57_pro_U0->ap_start(Block_Mat_exit57_pro_U0_ap_start);
    Block_Mat_exit57_pro_U0->start_full_n(Block_Mat_exit57_pro_U0_start_full_n);
    Block_Mat_exit57_pro_U0->ap_done(Block_Mat_exit57_pro_U0_ap_done);
    Block_Mat_exit57_pro_U0->ap_continue(Block_Mat_exit57_pro_U0_ap_continue);
    Block_Mat_exit57_pro_U0->ap_idle(Block_Mat_exit57_pro_U0_ap_idle);
    Block_Mat_exit57_pro_U0->ap_ready(Block_Mat_exit57_pro_U0_ap_ready);
    Block_Mat_exit57_pro_U0->start_out(Block_Mat_exit57_pro_U0_start_out);
    Block_Mat_exit57_pro_U0->start_write(Block_Mat_exit57_pro_U0_start_write);
    Block_Mat_exit57_pro_U0->rows(rows);
    Block_Mat_exit57_pro_U0->cols(cols);
    Block_Mat_exit57_pro_U0->img_0_rows_V_out_din(Block_Mat_exit57_pro_U0_img_0_rows_V_out_din);
    Block_Mat_exit57_pro_U0->img_0_rows_V_out_full_n(img_0_rows_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_0_rows_V_out_write(Block_Mat_exit57_pro_U0_img_0_rows_V_out_write);
    Block_Mat_exit57_pro_U0->img_0_cols_V_out_din(Block_Mat_exit57_pro_U0_img_0_cols_V_out_din);
    Block_Mat_exit57_pro_U0->img_0_cols_V_out_full_n(img_0_cols_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_0_cols_V_out_write(Block_Mat_exit57_pro_U0_img_0_cols_V_out_write);
    Block_Mat_exit57_pro_U0->img_1_rows_V_out_din(Block_Mat_exit57_pro_U0_img_1_rows_V_out_din);
    Block_Mat_exit57_pro_U0->img_1_rows_V_out_full_n(img_1_rows_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_1_rows_V_out_write(Block_Mat_exit57_pro_U0_img_1_rows_V_out_write);
    Block_Mat_exit57_pro_U0->img_1_cols_V_out_din(Block_Mat_exit57_pro_U0_img_1_cols_V_out_din);
    Block_Mat_exit57_pro_U0->img_1_cols_V_out_full_n(img_1_cols_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_1_cols_V_out_write(Block_Mat_exit57_pro_U0_img_1_cols_V_out_write);
    Block_Mat_exit57_pro_U0->img_2_rows_V_out_din(Block_Mat_exit57_pro_U0_img_2_rows_V_out_din);
    Block_Mat_exit57_pro_U0->img_2_rows_V_out_full_n(img_2_rows_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_2_rows_V_out_write(Block_Mat_exit57_pro_U0_img_2_rows_V_out_write);
    Block_Mat_exit57_pro_U0->img_2_cols_V_out_din(Block_Mat_exit57_pro_U0_img_2_cols_V_out_din);
    Block_Mat_exit57_pro_U0->img_2_cols_V_out_full_n(img_2_cols_V_c_full_n);
    Block_Mat_exit57_pro_U0->img_2_cols_V_out_write(Block_Mat_exit57_pro_U0_img_2_cols_V_out_write);
    ...
    img_0_rows_V_c_U = new fifo_w32_d1_A("img_0_rows_V_c_U");
    ...
    img_0_rows_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_0_rows_V_out_din);
    img_0_rows_V_c_U->if_full_n(img_0_rows_V_c_full_n);
    img_0_rows_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_0_rows_V_out_write);
    ...
    img_0_cols_V_c_U = new fifo_w32_d1_A("img_0_cols_V_c_U");
    ...
    img_0_cols_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_0_cols_V_out_din);
    img_0_cols_V_c_U->if_full_n(img_0_cols_V_c_full_n);
    img_0_cols_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_0_cols_V_out_write);
    ...
    img_1_rows_V_c_U = new fifo_w32_d3_A("img_1_rows_V_c_U");
    ...
    img_1_rows_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_1_rows_V_out_din);
    img_1_rows_V_c_U->if_full_n(img_1_rows_V_c_full_n);
    img_1_rows_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_1_rows_V_out_write);
    ...
    img_1_cols_V_c_U = new fifo_w32_d3_A("img_1_cols_V_c_U");
    ...
    img_1_cols_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_1_cols_V_out_din);
    img_1_cols_V_c_U->if_full_n(img_1_cols_V_c_full_n);
    img_1_cols_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_1_cols_V_out_write);
    ...
    img_2_rows_V_c_U = new fifo_w32_d4_A("img_2_rows_V_c_U");
    ...
    img_2_rows_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_2_rows_V_out_din);
    img_2_rows_V_c_U->if_full_n(img_2_rows_V_c_full_n);
    img_2_rows_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_2_rows_V_out_write);
    ...
    img_2_cols_V_c_U = new fifo_w32_d4_A("img_2_cols_V_c_U");
    ...
    img_2_cols_V_c_U->if_din(Block_Mat_exit57_pro_U0_img_2_cols_V_out_din);
    img_2_cols_V_c_U->if_full_n(img_2_cols_V_c_full_n);
    img_2_cols_V_c_U->if_write(Block_Mat_exit57_pro_U0_img_2_cols_V_out_write);
    ...
    img_0_rows_V_c17_U = new fifo_w32_d1_A("img_0_rows_V_c17_U");
    ...
    img_0_cols_V_c18_U = new fifo_w32_d1_A("img_0_cols_V_c18_U");
    ...
    img_2_data_stream_1_U = new fifo_w8_d1_A("img_2_data_stream_1_U");
    ...
    img_2_data_stream_2_U = new fifo_w8_d1_A("img_2_data_stream_2_U");
    ...
    start_for_CvtColoeOg_U->if_write(Block_Mat_exit57_pro_U0_start_write);
    ...
    start_for_Mat2AXIfYi_U->if_write(Block_Mat_exit57_pro_U0_start_write);
    ...
    SC_METHOD(thread_Block_Mat_exit57_pro_U0_ap_continue);

    SC_METHOD(thread_Block_Mat_exit57_pro_U0_ap_start);
    sensitive << ( ap_start );
    sensitive << ( ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready );

    SC_METHOD(thread_Block_Mat_exit57_pro_U0_start_full_n);
    ...
    sensitive << ( Block_Mat_exit57_pro_U0_ap_idle );
    ...
    SC_METHOD(thread_ap_sync_Block_Mat_exit57_pro_U0_ap_ready);
    sensitive << ( Block_Mat_exit57_pro_U0_ap_ready );
    sensitive << ( ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready );
    ...
    sensitive << ( ap_sync_Block_Mat_exit57_pro_U0_ap_ready );
    ...
    ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready = SC_LOGIC_0;
    Block_Mat_exit57_pro_U0_ap_ready_count = "00";
    ...
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_start, "Block_Mat_exit57_pro_U0_ap_start");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_start_full_n, "Block_Mat_exit57_pro_U0_start_full_n");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_done, "Block_Mat_exit57_pro_U0_ap_done");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_continue, "Block_Mat_exit57_pro_U0_ap_continue");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_idle, "Block_Mat_exit57_pro_U0_ap_idle");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_ready, "Block_Mat_exit57_pro_U0_ap_ready");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_start_out, "Block_Mat_exit57_pro_U0_start_out");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_start_write, "Block_Mat_exit57_pro_U0_start_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_0_rows_V_out_din, "Block_Mat_exit57_pro_U0_img_0_rows_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_0_rows_V_out_write, "Block_Mat_exit57_pro_U0_img_0_rows_V_out_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_0_cols_V_out_din, "Block_Mat_exit57_pro_U0_img_0_cols_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_0_cols_V_out_write, "Block_Mat_exit57_pro_U0_img_0_cols_V_out_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_1_rows_V_out_din, "Block_Mat_exit57_pro_U0_img_1_rows_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_1_rows_V_out_write, "Block_Mat_exit57_pro_U0_img_1_rows_V_out_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_1_cols_V_out_din, "Block_Mat_exit57_pro_U0_img_1_cols_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_1_cols_V_out_write, "Block_Mat_exit57_pro_U0_img_1_cols_V_out_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_2_rows_V_out_din, "Block_Mat_exit57_pro_U0_img_2_rows_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_2_rows_V_out_write, "Block_Mat_exit57_pro_U0_img_2_rows_V_out_write");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_2_cols_V_out_din, "Block_Mat_exit57_pro_U0_img_2_cols_V_out_din");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_img_2_cols_V_out_write, "Block_Mat_exit57_pro_U0_img_2_cols_V_out_write");
    ...
    sc_trace(mVcdFile, ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready, "ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready");
    sc_trace(mVcdFile, ap_sync_Block_Mat_exit57_pro_U0_ap_ready, "ap_sync_Block_Mat_exit57_pro_U0_ap_ready");
    sc_trace(mVcdFile, Block_Mat_exit57_pro_U0_ap_ready_count, "Block_Mat_exit57_pro_U0_ap_ready_count");
...
image_filter::~image_filter() {
    ...
    delete Block_Mat_exit57_pro_U0;
...
void image_filter::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sync_ready.read()) && 
         esl_seteq<1,1,1>(Block_Mat_exit57_pro_U0_ap_ready.read(), ap_const_logic_0))) {
        Block_Mat_exit57_pro_U0_ap_ready_count = (!Block_Mat_exit57_pro_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(Block_Mat_exit57_pro_U0_ap_ready_count.read()) - sc_biguint<2>(ap_const_lv2_1));
    } else if ((esl_seteq<1,1,1>(ap_sync_ready.read(), ap_const_logic_0) && 
                esl_seteq<1,1,1>(Block_Mat_exit57_pro_U0_ap_ready.read(), ap_const_logic_1))) {
        Block_Mat_exit57_pro_U0_ap_ready_count = (!Block_Mat_exit57_pro_U0_ap_ready_count.read().is_01() || !ap_const_lv2_1.is_01())? sc_lv<2>(): (sc_biguint<2>(Block_Mat_exit57_pro_U0_ap_ready_count.read()) + sc_biguint<2>(ap_const_lv2_1));
    }
    ...
    if ( ap_rst_n_inv.read() == ap_const_logic_1) {
        ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready = ap_const_logic_0;
    } else {
        if (esl_seteq<1,1,1>(ap_const_logic_1, (ap_start.read() & 
             ap_sync_ready.read()))) {
            ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready = ap_const_logic_0;
        } else {
            ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready = ap_sync_Block_Mat_exit57_pro_U0_ap_ready.read();
        }
    }
}
...
void image_filter::thread_Block_Mat_exit57_pro_U0_ap_continue() {
    Block_Mat_exit57_pro_U0_ap_continue = ap_const_logic_1;
}

void image_filter::thread_Block_Mat_exit57_pro_U0_ap_start() {
    Block_Mat_exit57_pro_U0_ap_start = (ap_start.read() & (ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready.read() ^ 
  ap_const_logic_1));
}

void image_filter::thread_Block_Mat_exit57_pro_U0_start_full_n() {
    Block_Mat_exit57_pro_U0_start_full_n = (start_for_CvtColor_U0_full_n.read() & start_for_Mat2AXIvideo_U0_full_n.read());
}
...
void image_filter::thread_ap_idle() {
    ap_idle = (Block_Mat_exit57_pro_U0_ap_idle.read() & AXIvideo2Mat_U0_ap_idle.read() & CvtColor_1_U0_ap_idle.read() & CvtColor_U0_ap_idle.read() & Mat2AXIvideo_U0_ap_idle.read());
}
...
void image_filter::thread_ap_sync_Block_Mat_exit57_pro_U0_ap_ready() {
    ap_sync_Block_Mat_exit57_pro_U0_ap_ready = (Block_Mat_exit57_pro_U0_ap_ready.read() | ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready.read());
}
...
void image_filter::thread_ap_sync_ready() {
    ap_sync_ready = (ap_sync_AXIvideo2Mat_U0_ap_ready.read() & ap_sync_Block_Mat_exit57_pro_U0_ap_ready.read());
}
