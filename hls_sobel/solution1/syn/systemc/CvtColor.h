...
struct CvtColor : public sc_module {
    ...
    sc_signal< sc_lv<1> > tmp_1_i_reg_247;
    ...
    sc_signal< sc_lv<11> > j_i_reg_187;
    ...
    sc_signal< sc_lv<1> > tmp_1_i_fu_217_p2;
    ...
    sc_signal< sc_lv<11> > i_i_reg_176;
