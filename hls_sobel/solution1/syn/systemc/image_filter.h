...
struct image_filter : public sc_module {
    ...
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_ap_start;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_start_full_n;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_ap_done;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_ap_continue;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_ap_idle;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_ap_ready;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_start_out;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_start_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_0_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_0_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_0_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_0_cols_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_1_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_1_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_1_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_1_cols_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_2_rows_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_2_rows_V_out_write;
    sc_signal< sc_lv<32> > Block_Mat_exit57_pro_U0_img_2_cols_V_out_din;
    sc_signal< sc_logic > Block_Mat_exit57_pro_U0_img_2_cols_V_out_write;
    ...
    sc_signal< sc_logic > ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready;
    sc_signal< sc_logic > ap_sync_Block_Mat_exit57_pro_U0_ap_ready;
    sc_signal< sc_lv<2> > Block_Mat_exit57_pro_U0_ap_ready_count;
    ...
    void thread_Block_Mat_exit57_pro_U0_ap_continue();
    void thread_Block_Mat_exit57_pro_U0_ap_start();
    void thread_Block_Mat_exit57_pro_U0_start_full_n();
    ...
    void thread_ap_sync_Block_Mat_exit57_pro_U0_ap_ready();
