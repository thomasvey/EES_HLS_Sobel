...
#ifndef _Block_Mat_exit57_pro_HH_
#define _Block_Mat_exit57_pro_HH_
...
struct Block_Mat_exit57_pro : public sc_module {
    ...
    // Module declarations
    Block_Mat_exit57_pro(sc_module_name name);
    SC_HAS_PROCESS(Block_Mat_exit57_pro);
