...
architecture behav of image_filter is 
    ...
    "image_filter,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=3,HLS_SYN_FF=932,HLS_SYN_LUT=2323}";
    ...
    signal Block_Mat_exit57_pro_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_start_out : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_0_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_0_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_0_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_0_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_1_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_1_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_1_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_1_cols_V_out_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_2_rows_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_2_rows_V_out_write : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_img_2_cols_V_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit57_pro_U0_img_2_cols_V_out_write : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit57_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit57_pro_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component Block_Mat_exit57_pro IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    Block_Mat_exit57_pro_U0 : component Block_Mat_exit57_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Block_Mat_exit57_pro_U0_ap_start,
        start_full_n => Block_Mat_exit57_pro_U0_start_full_n,
        ap_done => Block_Mat_exit57_pro_U0_ap_done,
        ap_continue => Block_Mat_exit57_pro_U0_ap_continue,
        ap_idle => Block_Mat_exit57_pro_U0_ap_idle,
        ap_ready => Block_Mat_exit57_pro_U0_ap_ready,
        start_out => Block_Mat_exit57_pro_U0_start_out,
        start_write => Block_Mat_exit57_pro_U0_start_write,
        rows => rows,
        cols => cols,
        img_0_rows_V_out_din => Block_Mat_exit57_pro_U0_img_0_rows_V_out_din,
        img_0_rows_V_out_full_n => img_0_rows_V_c_full_n,
        img_0_rows_V_out_write => Block_Mat_exit57_pro_U0_img_0_rows_V_out_write,
        img_0_cols_V_out_din => Block_Mat_exit57_pro_U0_img_0_cols_V_out_din,
        img_0_cols_V_out_full_n => img_0_cols_V_c_full_n,
        img_0_cols_V_out_write => Block_Mat_exit57_pro_U0_img_0_cols_V_out_write,
        img_1_rows_V_out_din => Block_Mat_exit57_pro_U0_img_1_rows_V_out_din,
        img_1_rows_V_out_full_n => img_1_rows_V_c_full_n,
        img_1_rows_V_out_write => Block_Mat_exit57_pro_U0_img_1_rows_V_out_write,
        img_1_cols_V_out_din => Block_Mat_exit57_pro_U0_img_1_cols_V_out_din,
        img_1_cols_V_out_full_n => img_1_cols_V_c_full_n,
        img_1_cols_V_out_write => Block_Mat_exit57_pro_U0_img_1_cols_V_out_write,
        img_2_rows_V_out_din => Block_Mat_exit57_pro_U0_img_2_rows_V_out_din,
        img_2_rows_V_out_full_n => img_2_rows_V_c_full_n,
        img_2_rows_V_out_write => Block_Mat_exit57_pro_U0_img_2_rows_V_out_write,
        img_2_cols_V_out_din => Block_Mat_exit57_pro_U0_img_2_cols_V_out_din,
        img_2_cols_V_out_full_n => img_2_cols_V_c_full_n,
        img_2_cols_V_out_write => Block_Mat_exit57_pro_U0_img_2_cols_V_out_write);
    ...
    img_0_rows_V_c_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_0_rows_V_out_din,
        if_full_n => img_0_rows_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_0_rows_V_out_write,
        if_dout => img_0_rows_V_c_dout,
        if_empty_n => img_0_rows_V_c_empty_n,
        if_read => AXIvideo2Mat_U0_img_rows_V_read);

    img_0_cols_V_c_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_0_cols_V_out_din,
        if_full_n => img_0_cols_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_0_cols_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_1_rows_V_out_din,
        if_full_n => img_1_rows_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_1_rows_V_out_write,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_1_cols_V_out_din,
        if_full_n => img_1_cols_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_1_cols_V_out_write,
        if_dout => img_1_cols_V_c_dout,
        if_empty_n => img_1_cols_V_c_empty_n,
        if_read => CvtColor_U0_p_src_cols_V_read);

    img_2_rows_V_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_2_rows_V_out_din,
        if_full_n => img_2_rows_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_2_rows_V_out_write,
        if_dout => img_2_rows_V_c_dout,
        if_empty_n => img_2_rows_V_c_empty_n,
        if_read => Mat2AXIvideo_U0_img_rows_V_read);

    img_2_cols_V_c_U : component fifo_w32_d4_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_Mat_exit57_pro_U0_img_2_cols_V_out_din,
        if_full_n => img_2_cols_V_c_full_n,
        if_write => Block_Mat_exit57_pro_U0_img_2_cols_V_out_write,
    ...
    img_0_rows_V_c17_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_0_cols_V_c18_U : component fifo_w32_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_2_data_stream_1_U : component fifo_w8_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_2_data_stream_2_U : component fifo_w8_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    port map (
        ...
        if_write => Block_Mat_exit57_pro_U0_start_write,
    ...
    ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ...
                    ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready <= ap_sync_Block_Mat_exit57_pro_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    Block_Mat_exit57_pro_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_sync_ready = ap_const_logic_1) and (ap_const_logic_0 = Block_Mat_exit57_pro_U0_ap_ready))) then 
                Block_Mat_exit57_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit57_pro_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Block_Mat_exit57_pro_U0_ap_ready))) then 
                Block_Mat_exit57_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit57_pro_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit57_pro_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Block_Mat_exit57_pro_U0_start_full_n <= (start_for_Mat2AXIvideo_U0_full_n and start_for_CvtColor_U0_full_n);
    ...
    OUTPUT_STREAM_TVALID <= Mat2AXIvideo_U0_OUTPUT_STREAM_TVALID;
    ap_done <= Mat2AXIvideo_U0_ap_done;
    ap_idle <= (Mat2AXIvideo_U0_ap_idle and CvtColor_U0_ap_idle and CvtColor_1_U0_ap_idle and Block_Mat_exit57_pro_U0_ap_idle and AXIvideo2Mat_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit57_pro_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit57_pro_U0_ap_ready or Block_Mat_exit57_pro_U0_ap_ready);
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Mat2AXIvideo_U0_ap_done;
    ap_sync_ready <= (ap_sync_Block_Mat_exit57_pro_U0_ap_ready and ap_sync_AXIvideo2Mat_U0_ap_ready);
